...
import mx.florinda.leitor.FabricaLeitoItensCardapio;
...
public class Cardapio {
    ...
    public Cardapio(String nomeArquivo) throws IOException {
        var fabricaLeitor = new FabricaLeitoItensCardapio();
        LeitorItensCardapio leitor = fabricaLeitor.criarLeitor(nomeArquivo);
        if (leitor != null) {
